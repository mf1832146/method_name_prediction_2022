...
def build_relative_position(query_size, key_size, max_relative_positions):
...
def ast2seq(root_node, index2code, ud2pos, args):
    ...
    ud_mask = clip_ud_mask(ud_mask, ud2pos, args.max_rel_pos)
...
if __name__ == '__main__':
    print(build_relative_position(10, 10, 5))
